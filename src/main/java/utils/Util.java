...
public class Util {
    ...
    public final static String base_url="http://localhost:8080/BlogProjectF_war_exploded/MainPage.jsp";
    public final static String base_url1 = "http://localhost:8080/BlogProjectF_war_exploded/";
